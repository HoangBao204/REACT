...
const Home = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const productResponse = await axios.get("https://www.loqlarchlinuxserver.xyz/yesking/product");
        setProducts(productResponse.data.products);
        const newProductResponse = await axios.get("https://www.loqlarchlinuxserver.xyz/yesking/newproduct");
